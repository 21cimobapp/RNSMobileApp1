...
import 'package:ciPatientApp/firebase/auth/phone_auth/select_country.dart';
import 'package:ciPatientApp/firebase/auth/phone_auth/verify.dart';
...
import 'package:ciPatientApp/src/pages/RegistrationPage.dart';
...
class _PhoneAuthGetPhoneState extends State<PhoneAuthGetPhone> {
  ...
  void initState() {
    ...
    if (globals.loginUserType == "DOCTOR") {
      appName = "Doctor Login";
    } else if (globals.loginUserType == "PATIENT") {
      appName = "Patient Login";
    }
  }
  ...
  void verifyCheck() {
    checkMobileExists().then((value) {
      if (value == 1) {
        ...
        _showSnackBar("Network Issue. Please try after some time");
      }
    }, onError: (error) {
      print(error);
    });
  ...
  Future<int> checkMobileExists() async {
    ...
    String url;
    if (globals.loginUserType == "DOCTOR") {
//      url = "http://www.21ci.com/MobileAppEx/Doctors/mapp_CheckMobileExists";
    } else {
//      url = "http://www.21ci.com/MobileAppEx/Patient/mapp_CheckMobileExists";
      url ="http://43.252.88.147/RNSMobAppAPI/Patient/mapp_CheckMobileExists";
    }
